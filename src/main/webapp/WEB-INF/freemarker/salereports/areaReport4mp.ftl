...
<#if period!='month'>
	...
	rankType : 'BRAND',
	// 销售概览URL
	generalUrl : '/BaseDemo/SaleOverview4mp/area/general.htm?period=days',
	// 运营商概览URL
	telcomUrl : '/BaseDemo/SaleOverview4mp/area/telcom.htm?period=days',
	// 排名概况URL
	rankUrls : {
        'BRAND' : '/BaseDemo/SaleOverview4mp/area/ranking/brand.htm?period=days',
        'GOODS' : '/BaseDemo/SaleOverview4mp/area/ranking/goods.htm?period=days',
        'MAINGOODS' : '/BaseDemo/SaleOverview4mp/area/ranking/maingoods.htm?period=days',
        'CHANNEL' : '/BaseDemo/SaleOverview4mp/area/ranking/channel.htm?period=days' 
	},
	rankingUrl : function(){
		return this.rankUrls[this.rankType];
	},
	// 品牌门店销售排名URL
	brandUrl: '/BaseDemo/SaleOverview4mp/area/brand/details.htm?period=days',
	// 主推门店销售排名URL
	maingoodsUrl: '/BaseDemo/SaleOverview4mp/area/maingoods/details.htm?period=days',
	// 销售明细URL
	detailsUrl : '/BaseDemo/SaleOverview4mp/area/details.htm?period=days',
	// 门店销售明细URL
	drillUrl : '/BaseDemo/SaleOverview4mp/store/details.htm?period=days'
<#else>
	// 初始化查询
	initQuery : function(){
		initMonthQuery();
	...
	rankType : 'BRAND',
	// 销售概览URL
	generalUrl : '/BaseDemo/SaleOverview4mp/area/general.htm?period=month',
	// 运营商概览URL
	telcomUrl : '/BaseDemo/SaleOverview4mp/area/telcom.htm?period=month',
	// 排名概况URL
	rankUrls : {
        'BRAND' : '/BaseDemo/SaleOverview4mp/area/ranking/brand.htm?period=month',
        'GOODS' : '/BaseDemo/SaleOverview4mp/area/ranking/goods.htm?period=month',
        'MAINGOODS' : '/BaseDemo/SaleOverview4mp/area/ranking/maingoods.htm?period=month',
        'CHANNEL' : '/BaseDemo/SaleOverview4mp/area/ranking/channel.htm?period=month' 
	},
	rankingUrl : function(){
		return this.rankUrls[this.rankType];
	},
	// 品牌门店销售排名URL
	brandUrl: '/BaseDemo/SaleOverview4mp/area/brand/details.htm?period=month',
	// 主推门店销售排名URL
	maingoodsUrl: '/BaseDemo/SaleOverview4mp/area/maingoods/details.htm?period=month',
	// 销售明细URL
	detailsUrl : '/BaseDemo/SaleOverview4mp/area/details.htm?period=month',
	// 门店销售明细URL
	drillUrl : '/BaseDemo/SaleOverview4mp/store/details.htm?period=month'
</#if>
};
</script>
</head>
