...
<#if period!='month'>
	...
	rankType : 'BRAND',
	// 销售概览URL
	generalUrl : '/pmc-pc-web/SaleOverview/headquarters/general.htm?period=days',
	// 运营商概览URL
	telcomUrl : '/pmc-pc-web/SaleOverview/headquarters/telcom.htm?period=days',
	// 排名概况URL
	rankUrls : {
        'BRAND' : '/pmc-pc-web/SaleOverview/headquarters/ranking/brand.htm?period=days',
        'GOODS' : '/pmc-pc-web/SaleOverview/headquarters/ranking/goods.htm?period=days',
        'MAINGOODS' : '/pmc-pc-web/SaleOverview/headquarters/ranking/maingoods.htm?period=days',
        'CHANNEL' : '/pmc-pc-web/SaleOverview/headquarters/ranking/channel.htm?period=days' 
	},
	rankingUrl : function(){
		return this.rankUrls[this.rankType];
	},
	// 品牌大区销售排名URL
	brandUrl: '/pmc-pc-web/SaleOverview/headquarters/brand/details.htm?period=days',
	// 品牌门店销售排名URL
	brandUrl1: '/pmc-pc-web/SaleOverview/area/brand/details.htm?period=days',
	// 主推大区销售排名URL
	maingoodsUrl: '/pmc-pc-web/SaleOverview/headquarters/maingoods/details.htm?period=days',
	// 主推门店销售排名URL
	maingoodsUrl1: '/pmc-pc-web/SaleOverview/area/maingoods/details.htm?period=days',
	// 销售明细URL
	detailsUrl : '/pmc-pc-web/SaleOverview/headquarters/details.htm?period=days',
	// 大区销售明细URL
	drillUrl : '/pmc-pc-web/SaleOverview/area/details.htm?period=days',
	// 门店销售明细URL
	drillUrl1 : '/pmc-pc-web/SaleOverview/store/details.htm?period=days'
<#else>
	// 初始化查询
	initQuery : function(){
		initMonthQuery();
	...
	rankType : 'BRAND',
	// 销售概览URL
	generalUrl : '/pmc-pc-web/SaleOverview/headquarters/general.htm?period=month',
	// 运营商概览URL
	telcomUrl : '/pmc-pc-web/SaleOverview/headquarters/telcom.htm?period=month',
	// 排名概况URL
	rankUrls : {
        'BRAND' : '/pmc-pc-web/SaleOverview/headquarters/ranking/brand.htm?period=month',
        'GOODS' : '/pmc-pc-web/SaleOverview/headquarters/ranking/goods.htm?period=month',
        'MAINGOODS' : '/pmc-pc-web/SaleOverview/headquarters/ranking/maingoods.htm?period=month',
        'CHANNEL' : '/pmc-pc-web/SaleOverview/headquarters/ranking/channel.htm?period=month' 
	},
	rankingUrl : function(){
		return this.rankUrls[this.rankType];
	},
	// 品牌大区销售排名URL
	brandUrl: '/pmc-pc-web/SaleOverview/headquarters/brand/details.htm?period=month',
	// 品牌门店销售排名URL
	brandUrl1: '/pmc-pc-web/SaleOverview/area/brand/details.htm?period=month',
	// 主推大区销售排名URL
	maingoodsUrl: '/pmc-pc-web/SaleOverview/headquarters/maingoods/details.htm?period=month',
	// 主推门店销售排名URL
	maingoodsUrl1: '/pmc-pc-web/SaleOverview/area/maingoods/details.htm?period=month',
	// 销售明细URL
	detailsUrl : '/pmc-pc-web/SaleOverview/headquarters/details.htm?period=month',
	// 大区销售明细URL
	drillUrl : '/pmc-pc-web/SaleOverview/area/details.htm?period=month',
	// 门店销售明细URL
	drillUrl1 : '/pmc-pc-web/SaleOverview/store/details.htm?period=month'
</#if>
};
</script>
</head>
...
<#if adminScope == 'admin'>
			<div class="menu-panel">
				...
				<div style="margin: 10px;">
					<label class="rct-label">销售明细:</label>
