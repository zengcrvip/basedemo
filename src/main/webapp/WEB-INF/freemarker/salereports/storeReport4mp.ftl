...
<#if period!='month'>
	...
	rankType : 'BRAND',
	// 销售概览URL
	generalUrl : '/pmc-pc-web/SaleOverview4mp/store/general.htm?period=days',
	// 运营商概览URL
	telcomUrl : '/pmc-pc-web/SaleOverview4mp/store/telcom.htm?period=days',
	// 排名概况URL
	rankUrls : {
        'BRAND' : '/pmc-pc-web/SaleOverview4mp/store/ranking/brand.htm?period=days',
        'GOODS' : '/pmc-pc-web/SaleOverview4mp/store/ranking/goods.htm?period=days',
        'MAINGOODS' : '/pmc-pc-web/SaleOverview4mp/store/ranking/maingoods.htm?period=days',
        'CHANNEL' : '/pmc-pc-web/SaleOverview4mp/store/ranking/channel.htm?period=days' 
	},
	rankingUrl : function(){
		return this.rankUrls[this.rankType];
	},
	// 销售明细URL
	detailsUrl : '/pmc-pc-web/SaleOverview4mp/store/details.htm?period=days',
	// 员工销售明细URL
	drillUrl : '/pmc-pc-web/SaleOverview4mp/store/employee/details.htm?period=days'
<#else>
	// 初始化查询
	initQuery : function(){
		initMonthQuery();
	...
	rankType : 'BRAND',
	// 销售概览URL
	generalUrl : '/pmc-pc-web/SaleOverview4mp/store/general.htm?period=month',
	// 运营商概览URL
	telcomUrl : '/pmc-pc-web/SaleOverview4mp/store/telcom.htm?period=month',
	// 排名概况URL
	rankUrls : {
        'BRAND' : '/pmc-pc-web/SaleOverview4mp/store/ranking/brand.htm?period=month',
        'GOODS' : '/pmc-pc-web/SaleOverview4mp/store/ranking/goods.htm?period=month',
        'MAINGOODS' : '/pmc-pc-web/SaleOverview4mp/store/ranking/maingoods.htm?period=month',
        'CHANNEL' : '/pmc-pc-web/SaleOverview4mp/store/ranking/channel.htm?period=month' 
	},
	rankingUrl : function(){
		return this.rankUrls[this.rankType];
	},
	// 销售明细URL
	detailsUrl : '/pmc-pc-web/SaleOverview4mp/store/details.htm?period=month',
	// 员工销售明细URL
	drillUrl : '/pmc-pc-web/SaleOverview4mp/store/employee/details.htm?period=month'
</#if>
};
</script>
</head>
