...
<#macro jindu val=0 max=0>
	<#if val?? && max?? && max != 0>
		...
		<#else>
			<div style="width:${mabs(jdval)}%;height:16px;background:#87CE45;" title="当前商品值为负数"></div>		
		</#if>
	<#else>
...
<#macro blockrender data=[] title="" measure="none" isarea=false isGM=false>
	<div class="rblock">
		<div class="ritem">
			...
			<span class="rcell rtitle"><#if isarea>对比区域商品<#else>${ORGTYPES[orgType]}商品</#if></span>
	...
	<#list data?sort_by("rankSort") as item>
			...
			<#else>
				...
				<span class="rcell rname" title="${item.name!}">${item.name!}</span>
...
<#-- 测试数据 -->
<#assign store=[
	{"rankSort": 1, "code": "1001", "name": "测试商品1", "value": 1323, "proportion": 15, "an": 15},
	{"rankSort": 2, "code": "1002", "name": "测试商品2", "value": 1123, "proportion": 15, "an": -15},
	{"rankSort": 3, "code": "1003", "name": "测试商品3", "value": 923, "proportion": 15, "an": 15},
	{"rankSort": 4, "code": "1004", "name": "测试商品4", "value": 823, "proportion": 15, "an": -15},
	{"rankSort": 5, "code": "1005", "name": "测试商品5", "value": 723, "proportion": 15, "an": -15},
	{"rankSort": 6, "code": "1006", "name": "测试商品6", "value": 623, "proportion": 15, "an": -15}
]>
<#assign area=[	
	{"rankSort": 1, "code": "1001", "name": "对比商品1", "value": 1323, "proportion": 15, "an": -15},
	{"rankSort": 2, "code": "1002", "name": "对比商品2", "value": 1123, "proportion": 15, "an": 15},
	{"rankSort": 3, "code": "1003", "name": "对比商品3", "value": 923, "proportion": 15, "an": 15},
	{"rankSort": 4, "code": "1004", "name": "对比商品4", "value": 823, "proportion": 15, "an": -15},
	{"rankSort": 5, "code": "1005", "name": "对比商品5", "value": 723, "proportion": 15, "an": -15},
	{"rankSort": 6, "code": "1006", "name": "对比商品6", "value": 623, "proportion": 15, "an": 15}
]>
