...
<title>大区销售总览<#if period!='month'>日报<#else>月报</#if></title>
...
<#if period!='month'>
	...
	rankType : 'BRAND',
	// 销售概览URL
	generalUrl : '/pmc-pc-web/SaleOverview/area/general.htm?period=days',
	// 运营商概览URL
	telcomUrl : '/pmc-pc-web/SaleOverview/area/telcom.htm?period=days',
	// 排名概况URL
	rankUrls : {
        'BRAND' : '/pmc-pc-web/SaleOverview/area/ranking/brand.htm?period=days',
        'GOODS' : '/pmc-pc-web/SaleOverview/area/ranking/goods.htm?period=days',
        'MAINGOODS' : '/pmc-pc-web/SaleOverview/area/ranking/maingoods.htm?period=days',
        'CHANNEL' : '/pmc-pc-web/SaleOverview/area/ranking/channel.htm?period=days' 
	},
	rankingUrl : function(){
		return this.rankUrls[this.rankType];
	},
	// 品牌门店销售排名URL
	brandUrl: '/pmc-pc-web/SaleOverview/area/brand/details.htm?period=days',
	// 主推门店销售排名URL
	maingoodsUrl: '/pmc-pc-web/SaleOverview/area/maingoods/details.htm?period=days',
	// 销售明细URL
	detailsUrl : '/pmc-pc-web/SaleOverview/area/details.htm?period=days',
	// 门店销售明细URL
	drillUrl : '/pmc-pc-web/SaleOverview/store/details.htm?period=days'
<#else>
	// 初始化查询
	initQuery : function(){
		initMonthQuery();
	...
	rankType : 'BRAND',
	// 销售概览URL
	generalUrl : '/pmc-pc-web/SaleOverview/area/general.htm?period=month',
	// 运营商概览URL
	telcomUrl : '/pmc-pc-web/SaleOverview/area/telcom.htm?period=month',
	// 排名概况URL
	rankUrls : {
        'BRAND' : '/pmc-pc-web/SaleOverview/area/ranking/brand.htm?period=month',
        'GOODS' : '/pmc-pc-web/SaleOverview/area/ranking/goods.htm?period=month',
        'MAINGOODS' : '/pmc-pc-web/SaleOverview/area/ranking/maingoods.htm?period=month',
        'CHANNEL' : '/pmc-pc-web/SaleOverview/area/ranking/channel.htm?period=month' 
	},
	rankingUrl : function(){
		return this.rankUrls[this.rankType];
	},
	// 品牌门店销售排名URL
	brandUrl: '/pmc-pc-web/SaleOverview/area/brand/details.htm?period=month',
	// 主推门店销售排名URL
	maingoodsUrl: '/pmc-pc-web/SaleOverview/area/maingoods/details.htm?period=month',
	// 销售明细URL
	detailsUrl : '/pmc-pc-web/SaleOverview/area/details.htm?period=month',
	// 门店销售明细URL
	drillUrl : '/pmc-pc-web/SaleOverview/store/details.htm?period=month'
</#if>
};
</script>
</head>
...
<#if adminScope == 'admin'>
	...
	<div id="reportPanel">
		...
		<div class="report-title">
			<span>${areaName}大区 销售总览<#if period!='month'>(日)<#else>(月)</#if></span>
		</div>
		...
		<div class="report-region">
			...
			<div id="DETAILS_PANEL">
				<div class="part-header">
					<span class="title">大区及各门店销售明细</span>
				</div>
