...
<title>总部销售总览<#if period!='month'>日报<#else>月报</#if></title>
...
<#if period!='month'>
	...
	rankType : 'BRAND',
	// 销售概览URL
	generalUrl : '/pmc-pc-web/SaleOverview4mp/headquarters/general.htm?period=days',
	// 运营商概览URL
	telcomUrl : '/pmc-pc-web/SaleOverview4mp/headquarters/telcom.htm?period=days',
	// 排名概况URL
	rankUrls : {
        'BRAND' : '/pmc-pc-web/SaleOverview4mp/headquarters/ranking/brand.htm?period=days',
        'GOODS' : '/pmc-pc-web/SaleOverview4mp/headquarters/ranking/goods.htm?period=days',
        'MAINGOODS' : '/pmc-pc-web/SaleOverview4mp/headquarters/ranking/maingoods.htm?period=days',
        'CHANNEL' : '/pmc-pc-web/SaleOverview4mp/headquarters/ranking/channel.htm?period=days' 
	},
	rankingUrl : function(){
		return this.rankUrls[this.rankType];
	},
	// 品牌大区销售排名URL
	brandUrl: '/pmc-pc-web/SaleOverview4mp/headquarters/brand/details.htm?period=days',
	// 品牌门店销售排名URL
	brandUrl1: '/pmc-pc-web/SaleOverview4mp/area/brand/details.htm?period=days',
	// 主推大区销售排名URL
	maingoodsUrl: '/pmc-pc-web/SaleOverview4mp/headquarters/maingoods/details.htm?period=days',
	// 主推门店销售排名URL
	maingoodsUrl1: '/pmc-pc-web/SaleOverview4mp/area/maingoods/details.htm?period=days',
	// 销售明细URL
	detailsUrl : '/pmc-pc-web/SaleOverview4mp/headquarters/details.htm?period=days',
	// 大区销售明细URL
	drillUrl : '/pmc-pc-web/SaleOverview4mp/area/details.htm?period=days',
	// 门店销售明细URL
	drillUrl1 : '/pmc-pc-web/SaleOverview4mp/store/details.htm?period=days'
<#else>
	// 初始化查询
	initQuery : function(){
		initMonthQuery();
	...
	rankType : 'BRAND',
	// 销售概览URL
	generalUrl : '/pmc-pc-web/SaleOverview4mp/headquarters/general.htm?period=month',
	// 运营商概览URL
	telcomUrl : '/pmc-pc-web/SaleOverview4mp/headquarters/telcom.htm?period=month',
	// 排名概况URL
	rankUrls : {
        'BRAND' : '/pmc-pc-web/SaleOverview4mp/headquarters/ranking/brand.htm?period=month',
        'GOODS' : '/pmc-pc-web/SaleOverview4mp/headquarters/ranking/goods.htm?period=month',
        'MAINGOODS' : '/pmc-pc-web/SaleOverview4mp/headquarters/ranking/maingoods.htm?period=month',
        'CHANNEL' : '/pmc-pc-web/SaleOverview4mp/headquarters/ranking/channel.htm?period=month' 
	},
	rankingUrl : function(){
		return this.rankUrls[this.rankType];
	},
	// 品牌大区销售排名URL
	brandUrl: '/pmc-pc-web/SaleOverview4mp/headquarters/brand/details.htm?period=month',
	// 品牌门店销售排名URL
	brandUrl1: '/pmc-pc-web/SaleOverview4mp/area/brand/details.htm?period=month',
	// 主推大区销售排名URL
	maingoodsUrl: '/pmc-pc-web/SaleOverview4mp/headquarters/maingoods/details.htm?period=month',
	// 主推门店销售排名URL
	maingoodsUrl1: '/pmc-pc-web/SaleOverview4mp/area/maingoods/details.htm?period=month',
	// 销售明细URL
	detailsUrl : '/pmc-pc-web/SaleOverview4mp/headquarters/details.htm?period=month',
	// 大区销售明细URL
	drillUrl : '/pmc-pc-web/SaleOverview4mp/area/details.htm?period=month',
	// 门店销售明细URL
	drillUrl1 : '/pmc-pc-web/SaleOverview4mp/store/details.htm?period=month'
</#if>
};
</script>
</head>
...
<#list areas as item>
					<option value="AREA:${item.ID}"<#if item.ID=='10001'>selected</#if>>${item.ID} ${item.NAME}</option>
</#list>
				</select>
				<a id="queryBtn" href="javascript:doQueryReport();void(0);" class="rct-button" style="margin-left: 10px;">查 询</a>
			</div>
<#if adminScope == 'admin'>
</#if>
		</div>
	...
	<div id="reportPanel">
		<div class="report-title">
			<span id="L_SECTOR">${sector.NAME} </span>
			<span>销售总览<#if period!='month'>(日)<#else>(月)</#if></span>
		</div>
		...
		<div class="report-region">
			...
			<div id="DETAILS_PANEL">
				<div class="part-header">
					<span class="title">总部及各大区销售明细</span>
				</div>
		...
		<!-- 穿透排名对话框 -->
		<div id="RANKING_DLG" class="rct-modal">
			<a href="#" class="rct-modal-close">×</a>
			<div class="rct-modal-header">
				<div class="title">品牌大区销售</div>
			</div>
			<div class="rct-modal-content">
				<div class="dialog-panel ranking-area"></div>
			</div>
			<div class="rct-modal-footer">
				<a href="#" class="rct-button">确定</a> 
				<a href="#" class="rct-button">关闭</a>
